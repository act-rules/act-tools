...
describe('getConsistency', () => {
  ...
  describe('consistency: null', () => {
    it('is null for passing false positives', () => {
      expect(getConsistency({
        ...procedureDefaults,
        testResults: [{
          testcaseId: '1',
          expected: 'passed',
    ...
    it('is null for inapplicable false positives', () => {
      expect(getConsistency({
        ...procedureDefaults,
        testResults: [{
          testcaseId: '1',
  ...
  describe('minimal consistancy', () => {
    it('is minimal when passed / failed are all cantTell', () => {
      expect(getConsistency({
        ...procedureDefaults,
        testResults: [{
          testcaseId: '1',
